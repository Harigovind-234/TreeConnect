...
class UserRegister(BaseModel):
    ...
    idProofUrl: Optional[str] = ""
    supportingDocument: Optional[str] = ""
    supportingUrl: Optional[str] = ""
    forestLicenceDoc: Optional[str] = ""
    forestLicenceUrl: Optional[str] = ""
    tradeLicenceDoc: Optional[str] = ""
    tradeLicenceUrl: Optional[str] = ""
    gstDoc: Optional[str] = ""
    gstUrl: Optional[str] = ""
    businessCertDoc: Optional[str] = ""
    businessCertUrl: Optional[str] = ""
    landTaxInvoiceDoc: Optional[str] = ""
    landTaxInvoiceUrl: Optional[str] = ""
